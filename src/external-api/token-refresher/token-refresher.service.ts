...
export class TokenRefresherService {
  ...
  constructor(
    ...
    this.accessTokenUrl = this.configService.get<string>(
      'siebel.oauth.accessTokenUrl',
    );
    this.clientId = this.configService.get<string>('siebel.oauth.clientId');
    this.clientSecret = this.configService.get<string>(
      'siebel.oauth.clientSecret',
    );
  }
